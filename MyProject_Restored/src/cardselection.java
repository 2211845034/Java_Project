...
public class cardselection extends javax.swing.JFrame {
    ...
    // Constructor بالمعاملات
    public cardselection(String p1, String p2, String p3, String p4, double p5, String p6) {
        initComponents();
        groupButton();
 ...
 this.setVisible(false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cardselection("MOVIE", "THEATER", "TIME", "TICKETS", 100.0, "DATE").setVisible(true);
            }
        });
    }
