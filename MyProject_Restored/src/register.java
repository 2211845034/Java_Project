...
import java.util.logging.FileHandler; // <--- تأكد من وجود هذا الاستيراد
import java.util.logging.SimpleFormatter; // <--- تأكد من وجود هذا الاستيراد
import java.io.IOException; // <--- تأكد من وجود هذا الاستيراد
...
public class register extends javax.swing.JFrame {
    ...
    // تعريف كائن الـ Logger هنا
    private static final Logger logger = Logger.getLogger(register.class.getName());

    // <START ADDITION - هنا سنضيف كود تهيئة FileHandler برمجياً>
    ...
    public register() {
        ...
        logger.info("Register form initialized and database connection attempted.");
        if (conn == null) {
            logger.severe("Database connection is null after initialization. Check JavaApplication4.ConnecrDb().");
        }
    }
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String d=jTextField4.getText();
           ...
           logger.info("Sign Up button clicked. Attempting to register user: " + a);

    if (conn == null) {
            JOptionPane.showMessageDialog(this, "Database connection not established. Cannot register.");
            logger.severe("Registration failed: Database connection is null.");
            return; // توقف هنا إذا لم يكن هناك اتصال
        }
       /**Statement s;
       ResultSet rs;
       try
       ...
       try{
          ...
          String s1=("insert into register(name,email,password,phone) values('"+a+"','"+b+"','"+c+"','"+d+"');");
       ...
       catch(SQLException e)
       {
           ...
           Logger.getLogger(register.class.getName()).log(Level.INFO,null,e);
       }
